...
bootstrap:
	...
	@bash -n scripts/deploy.sh scripts/backup.sh scripts/health-monitor.sh scripts/bootstrap-prod-env.sh scripts/install-compose-plugin.sh tests/test_integration.sh
